...
\section{Experience}
\runsubsection{Mylan Pharmaceuticals}
\descript{| Specialist, Consumer Analytics}
\location{Aug. 2015 - Present | Morgantown, WV}
...
\descript{| Lecturer}
\location{Jan. 2016 - Present | California, PA}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
