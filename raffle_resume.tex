...
\begin{minipage}[t]{0.68\textwidth}
  ...
  \descript{Dir. Data Science | Workers' Comp \& Group Benefits}\hfill
...
\begin{minipage}[t]{0.9\textwidth}
  ...
  \descript{Math Budy, HIG Math \& Reading Buddies}\hfill\location{2018-2019}\\
