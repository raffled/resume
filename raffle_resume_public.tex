...
\section{Experience}
\runsubsection{The Hartford}
\descript{| Data Scientist}
\location{Feb. 2017 - Present | Hartford, CT}
\vspace{\topsep}
\begin{tightitemize}
...
\item Designed a  model scoring engine which 
  can serve predictions from a suite of machine learning algorithms with
  $<500$ms response time via a SOAP web service.
